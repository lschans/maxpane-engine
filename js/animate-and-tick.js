function animate() {
    ...
    // Print coords on top
    positionBox.innerHTML = 'Velocity x: ' + Math.round(velocity.x) +
    ', y: ' + Math.round(velocity.y) +
    ', z: ' + Math.round(velocity.z) +
    '  ---  ' +
    'Position: x: ' + Math.round(controls.getObject().position.x) +
    ', y: ' + Math.round(controls.getObject().position.y) +
    ', z: ' + Math.round(controls.getObject().position.z);
